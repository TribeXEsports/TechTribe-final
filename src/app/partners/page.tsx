...
const companyPartners = [
  { name: "Innovate Corp", logo: "https://picsum.photos/seed/partner1/150/80", hint: "company logo" },
  { name: "Tech Solutions Ltd.", logo: "https://picsum.photos/seed/partner2/150/80", hint: "corporate logo" },
  { name: "Future Systems", logo: "https://picsum.photos/seed/partner3/150/80", hint: "business logo" },
  { name: "QuantumLeap", logo: "https://picsum.photos/seed/partner4/150/80", hint: "tech logo" },
  { name: "NextGen AI", logo: "https://picsum.photos/seed/partner5/150/80", hint: "startup logo" },
  { name: "DataWeavers", logo: "https://picsum.photos/seed/partner6/150/80", hint: "data logo" },
  { name: "CloudPioneers", logo: "https://picsum.photos/seed/partner7/150/80", hint: "cloud logo" },
  { name: "EcoBuilders", logo: "https://picsum.photos/seed/partner8/150/80", hint: "sustainability logo" },
]

const universityChapters = [
  { name: "Metropolis University", logo: "https://picsum.photos/seed/uni1/100/100", hint: "university seal" },
  { name: "Gotham State University", logo: "https://picsum.photos/seed/uni2/100/100", hint: "college crest" },
  { name: "Starling City College", logo: "https://picsum.photos/seed/uni3/100/100", hint: "campus logo" },
  { name: "National City University", logo: "https://picsum.photos/seed/uni4/100/100", hint: "university icon" },
]
