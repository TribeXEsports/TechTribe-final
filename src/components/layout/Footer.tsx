        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <ul className="mt-4 space-y-2 text-sm">
                    <li><Link href="/contact" className="text-muted-foreground hover:text-primary">Contact Us</Link></li>
                     <li><Link href="/founder" className="text-muted-foreground hover:text-primary">Founder</Link></li>
                  </ul>
                </div>
             </div>
          </div>
         ...
         <div className="mt-8 border-t pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
                <Link href="https://wa.me/919554037585" aria-label="Contact us on WhatsApp" target="_blank" rel="noopener noreferrer">
                    <WhatsappIcon className="h-5 w-5 text-muted-foreground transition-colors hover:text-primary" />
                </Link>
                <Link href="https://discord.gg/W35QZ8H5" aria-label="Join our Discord community" target="_blank" rel="noopener noreferrer">
                    <DiscordIcon className="h-5 w-5 text-muted-foreground transition-colors hover:text-primary" />
                </Link>
                <Link href="https://twitter.com/SwastikMishra_" aria-label="Follow us on Twitter" target="_blank" rel="noopener noreferrer">
                    <Twitter className="h-5 w-5 text-muted-foreground transition-colors hover:text-primary" />
                </Link>
                <Link href="https://github.com/swastik-h" aria-label="View our GitHub profile" target="_blank" rel="noopener noreferrer">
                    <Github className="h-5 w-5 text-muted-foreground transition-colors hover:text-primary" />
                </Link>
                <Link href="https://www.linkedin.com/in/myselfswastikmishra/" aria-label="Connect with us on LinkedIn" target="_blank" rel="noopener noreferrer">
