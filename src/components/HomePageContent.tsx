...
import { galleryImage1, otherGalleryImages } from "@/lib/gallery-images"
...
export function HomePageContent() {
  const galleryImages = [
    { src: galleryImage1, alt: "Tech TribeX community group photo", hint: "team photo" },
    ...otherGalleryImages,
  ]
  ...
  const featuredProjects = [
    {
      ...
      image: { src: "https://picsum.photos/seed/project1/600/400", hint: "tech website" },
    ...
    },
    {
      ...
      image: { src: "https://picsum.photos/seed/project2/600/400", hint: "branding design" },
